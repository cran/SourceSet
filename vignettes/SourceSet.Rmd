...
<center><!--Necessario per centrare l'immagine -->
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
1. Download [Cytoscape] (http://www.cytoscape.org/download.php) (version 3.3 or later)
...
[^commandline]: under some versions it is necessary to install manually [Command Line Implementation](http://apps.cytoscape.org/apps/commandlineimplementation).
